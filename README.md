...
This ia a Star Registry Service that allows users to claim ownerthip of their favorite star in the night sky. 
...
## Sequence
![workflow](/img/project4-workflow.png)
...
**GET: /stars/hash:[HASH]**
* Description
    * Get block data by hash from the blockchain
...
* Description
    * Get block data by wallte address from the blockchain
